...
public interface Data {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getTransaction", targetNamespace = "http://auctioneer/", className = "auctioneer.GetTransaction")
    @ResponseWrapper(localName = "getTransactionResponse", targetNamespace = "http://auctioneer/", className = "auctioneer.GetTransactionResponse")
    @Action(input = "http://auctioneer/Data/getTransactionRequest", output = "http://auctioneer/Data/getTransactionResponse")
